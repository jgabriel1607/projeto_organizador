...
export function addGame(gameId, gameTitle, gameSummary, gamePlatformList, gameDevelopers, gamePublishers, gameReleaseDate, gameGenre, gameBackgroundImage, gameSquareIcon, gameVerticalCover, gameStatus){
    const newGame = {
        id: gameId,
        title: gameTitle,
        summary: gameSummary,
    ...
    if(gameGenre.length <= 0 || gamePlatformList.length <= 0){
      if(gameGenre.length <= 0){      
        alert("O campo Gêneros não pode ficar vazio.")
      }
      if(gamePlatformList.length <= 0){      
        alert("O campo Plataformas não pode ficar vazio.")
      }
    }    
    else{      
    ...
    // const reordenarGames = () =>{
		// 	let count = 0
		// 	let tempGameList = games.map(obj =>{				
		// 		let tempGame = {...obj, id: count}
		// 		count ++
		// 		return tempGame
		// 	})
		// 	return tempGameList
...
export function editGame(gameId, gameTitle, gameSummary, gamePlatformList, gameDevelopers, gamePublishers, gameReleaseDate, gameGenre, gameBackgroundImage, gameSquareIcon, gameVerticalCover, gameStatus, history) {
  const newGame = {
    id: gameId,
    title: gameTitle,
    summary: gameSummary,
